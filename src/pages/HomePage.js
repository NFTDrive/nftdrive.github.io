...
<br /><br /><br /><br />
      ...
      <Row>
		< Col sm={6} md={6} lg={6} xl={6}>
		<h1>How it works </h1>
		<p>Save an NFT Drive in your Metamask wallet,  you can get it above, find your purchase transaction and identify your Smart Contract number which is in "Tokens Transferred" section and click in [1], inside is your contract number</p>
		<p>Go to "Text o File " in the menu of the  DApp and connect your wallet</p>
		<p>Write a text or upload a file, this last one, the archive  goes to the interplanetary file system or IPFS and our App saves it on the blockchain of your NFT Drive</p>
